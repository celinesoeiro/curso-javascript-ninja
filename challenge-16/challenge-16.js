(function() {
	...
	*/
	console.log( '\nMeus amigos:' );
	var nomes = ['celine', 'caio', 'lucas', 'maria', 'ana'];
	...
	*/
	console.log( '\nParte de uma string:' );
	var ind = 'Fernando'.lastIndexOf('nando');
	console.log('Fernando'.slice(ind));
	console.log('Fernando'.substring(8,3)); // pega a ultima letra, o, até a terceira, n
	...
	*/
	...
	for (var i = 0, l = myName.length; i < l; i++){
		if (i%2===0){
			myNewName[i] = (myName.slice(i,i+1).toUpperCase(i));
		}
		else {myNewName[i] = (myName.slice(i,i+1).toLowerCase(i));}		
	}
