(function() {
	...
	*/
	...
	console.log(text.replace(/Manuel Marques de Sousa/,'Celine Soeiro'));
	...
	*/
	...
	console.log(text.replace(/brasileiro/,'manauara'));
	...
	*/
	var newText = [];
	var text1 = 'O Centauro de Luvas';
	console.log( '\n"O Centauro de Luvas" em caixa alta:' );	

	for (var i=0; i<text1.length; i++){
		newText[i] = text1[i].toUpperCase();	
	}

	console.log(text.replace(text1, newText.join('')));
	...
	*/
	...
	//OU
	function getMonthNumber1(month){
		var months={
			'janeiro':'01',
			'fevereiro':'02',
			'março':'03',
	...
	console.log('O mês de março é representado pelo número ' + getMonthNumber1('março'))
	console.log('O mês de setembro é representado pelo número ' + getMonthNumber1('setembro'))
	console.log('O mês de dezembro é representado pelo número ' + getMonthNumber1('dezembro'))
