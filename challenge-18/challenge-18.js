(function IIFE(){
	...
	*/
	...
	var cpf1 = cleanCPF("049-214 3421-1").replace(/(\d\d\d)(\d\d\d)(\d\d\d)(\d\d)/g,'$1.$2.$3-$4');
	var cpf2 = cleanCPF("210.458.522-05").replace(/(\d\d\d)(\d\d\d)(\d\d\d)(\d\d)/g,'$1.$2.$3-$4');
	var cpf3 = cleanCPF("735 500 794 - 22").replace(/(\d\d\d)(\d\d\d)(\d\d\d)(\d\d)/g,'$1.$2.$3-$4');
	var cpf4 = cleanCPF("101.123-131x32").replace(/(\d\d\d)(\d\d\d)(\d\d\d)(\d\d)/g,'$1.$2.$3-$4');
	console.log(cpf1)
	console.log(cpf2)
	console.log(cpf3)
	console.log(cpf4)
	...
	*/
	...
	console.log(text.match(/ju\w\w\w/g))
	...
	*/
	...
	var text1 = "<div><section><blockquote>Texto <img /></blockquote></section></div>";
	...
	*/
	...
	console.log(text2.match(/<\w{1,}><\/\w{1,}>/g))
	...
	*/
	...
	var text3 = "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>";
	const regex3 = /(<\w+>)([^<]+)(<\/\w+>)/g
	console.log(text3.replace(regex3,'$1O texto dentro da tag "$1" é "$2"$3\n'))
})();