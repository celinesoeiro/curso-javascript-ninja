...
(function IIFE(){
    ...
    */
    function calculator(x,y){
        return function outra(callback){
            return callback(x,y);
        };
    }
    ...
    */
    ...
    var anomSum = sum(soma)
    console.log( 'O resultado da soma é: '+anomSum );
    ...
    */
    ...
    var anomSub = subtraction(sub);
    console.log( 'O resultado da subtração é:'+anomSub);

    function mult(x,y){
        return x*y;
    }
    var anomMult = multiplication(mult);
    console.log( 'O resultado da multiplicação é:' + anomMult );

    function div(x,y){
        return x/y;
    }
    var anomDiv = division(div);
    console.log( 'O resultado da divisão é:' + anomDiv);

    function modulus(x,y){
        return x%y;
    }
    var anomMod = mod(modulus);
    console.log( 'O resto do módulo é:' + anomMod);
